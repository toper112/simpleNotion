    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-6">
      <div className="rounded-3xl border border-zinc-800 bg-zinc-900/80 p-4 sm:p-6 shadow-2xl shadow-black/20">
        ...
        <textarea
          ...
          disabled={!canEdit}
          className="w-full min-h-[220px] bg-zinc-950 border border-zinc-800 rounded-2xl p-4 outline-none resize-none disabled:opacity-70 disabled:cursor-not-allowed"
        />
